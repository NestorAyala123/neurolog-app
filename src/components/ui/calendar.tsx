...
// Icon components moved outside of Calendar
const IconLeft = (props: React.SVGProps<SVGSVGElement>) => <ChevronLeftIcon className="h-4 w-4" {...props} />;
const IconRight = (props: React.SVGProps<SVGSVGElement>) => <ChevronRightIcon className="h-4 w-4" {...props} />;
